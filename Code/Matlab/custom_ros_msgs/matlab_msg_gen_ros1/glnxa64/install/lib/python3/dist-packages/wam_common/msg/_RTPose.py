...
"""autogenerated by genpy from wam_common/RTPose.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.pos_rate_limits is None:
        self.pos_rate_limits = [0.] * 3
      if self.ortn_rate_limits is None:
        self.ortn_rate_limits = [0.] * 4
    else:
      self.position = [0.] * 3
      self.orientation = [0.] * 4
      self.pos_rate_limits = [0.] * 3
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_3f().pack(*self.pos_rate_limits))
      buff.write(_get_struct_4f().pack(*self.ortn_rate_limits))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.pos_rate_limits = _get_struct_3f().unpack(str[start:end])
      start = end
      end += 16
      self.ortn_rate_limits = _get_struct_4f().unpack(str[start:end])
      return self
