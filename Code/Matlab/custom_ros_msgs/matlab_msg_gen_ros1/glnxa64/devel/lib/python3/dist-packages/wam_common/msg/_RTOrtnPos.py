...
"""autogenerated by genpy from wam_common/RTOrtnPos.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_4f().pack(*self.rate_limits))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.rate_limits = _get_struct_4f().unpack(str[start:end])
      return self
