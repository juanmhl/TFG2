...
"""autogenerated by genpy from wam_common/RTCartVel.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_get_struct_3f().pack(*self.direction))
      _x = self.magnitude
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.direction = _get_struct_3f().unpack(str[start:end])
      start = end
      end += 4
      (self.magnitude,) = _get_struct_f().unpack(str[start:end])
      return self
