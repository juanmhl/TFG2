...
classdef PoseRequest < ros.Message
    %PoseRequest MATLAB implementation of wam_common/PoseRequest
    %   This class was automatically generated by
    %   ros.internal.pubsubEmitter.
    %   Copyright 2014-2020 The MathWorks, Inc.
    properties (Constant)
        MessageType = 'wam_common/PoseRequest' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.wam_common.PoseRequest.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.wam_common.PoseRequest(strObj);
        end
    end
end
