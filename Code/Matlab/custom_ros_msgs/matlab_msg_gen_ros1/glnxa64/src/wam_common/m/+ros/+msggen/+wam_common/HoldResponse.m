...
classdef HoldResponse < ros.Message
    %HoldResponse MATLAB implementation of wam_common/HoldResponse
    %   This class was automatically generated by
    %   ros.internal.pubsubEmitter.
    %   Copyright 2014-2020 The MathWorks, Inc.
    properties (Constant)
        MessageType = 'wam_common/HoldResponse' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.wam_common.HoldResponse.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.wam_common.HoldResponse(strObj);
        end
    end
end
